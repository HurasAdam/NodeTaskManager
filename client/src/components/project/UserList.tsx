...
import { ListBox, Listbox, Transition } from "@headlessui/react";
import { Fragment, useEffect, useState } from "react";
import { BsChevronExpand } from "react-icons/bs";
import { MdCheck } from "react-icons/md";
import { getInitials } from '../../utils';

const UserList: React.FC<{ title: string }> = ({ title, data, pm, members, setValue, register, error, name, selectedUsers }) => {
